...
class ImageDecoder(
    ...
    private var decoder: tachiyomi.decoder.ImageDecoder? = null
    ...
    override fun decodeRegion(sRect: Rect, sampleSize: Int): Bitmap {
        ...
        val bitmap = decoder!!.decode(sRect, config, sampleSize, false, null)
...
private val TAG = ImageDecoder::class.java.simpleName
